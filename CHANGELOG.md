...
## [13.0.0-rc](https://github.com/digitty-forks/node-restify/compare/v12.0.0...v13.0.0-rc) (2026-09-04)


### ⚠ BREAKING CHANGES

* upgrade qs ([#1995](https://github.com/digitty-forks/node-restify/issues/1995))
* Node.js 26 support ([#1999](https://github.com/digitty-forks/node-restify/issues/1999))
* remove deprecated spdy protocol ([#1998](https://github.com/digitty-forks/node-restify/issues/1998))
* upgrade qs ([#1991](https://github.com/digitty-forks/node-restify/issues/1991))
* don't override req.log if set during .first
* use req.log on audit plugin
* support v18.x
* remove deprecated usage of pino.child ([#1902](https://github.com/digitty-forks/node-restify/issues/1902))
* deprecates and removes re-routing when passing a string parameter to `next()`
* adds async/await support to pre, use and handler chains
* drops suppoprt to node 8 and updates linting rules
* **server:** 
...
* Ability to find a route by a path ([711a489](https://github.com/digitty-forks/node-restify/commit/711a4897800e2ef8bc4a1a9c6cc833af71cd925d))
* add router.render() back to support hypermedia usecase ([#1752](https://github.com/digitty-forks/node-restify/issues/1752)) ([0700cfd](https://github.com/digitty-forks/node-restify/commit/0700cfd445e45401c36c4229e37e12b8220339d9))
* add support for non-strict formatters ([#1721](https://github.com/digitty-forks/node-restify/issues/1721)) ([de1833a](https://github.com/digitty-forks/node-restify/commit/de1833a44084e5f231de289421518ec646b86f60))
* add useSemicolonDelimiter option ([#2004](https://github.com/digitty-forks/node-restify/issues/2004)) ([e4102d8](https://github.com/digitty-forks/node-restify/commit/e4102d822d298e4a912758a76788a5d4473ab7f7))
* allow alternate name for request id in logs ([cbd16ef](https://github.com/digitty-forks/node-restify/commit/cbd16efa3be36e7888ecccc15ee28eaa8fa6c5ef))
* allow custom alternatives to domains ([54adfcb](https://github.com/digitty-forks/node-restify/commit/54adfcbdea1a6be3675dbc05573f8063fc16a05b))
* async/await support ([12be9e2](https://github.com/digitty-forks/node-restify/commit/12be9e243a407eaf7a30cbb16e399ee2a46dec93))
* **audit:** Add the ability to specify a custom audit log serializer (for err, req and res) ([#1746](https://github.com/digitty-forks/node-restify/issues/1746)) ([6231acd](https://github.com/digitty-forks/node-restify/commit/6231acda7e16ce64253b08039bd0ad341126c11a))
* bump dtrace-provider version to avoid MacOS errors ([fa52f60](https://github.com/digitty-forks/node-restify/commit/fa52f60d85c3df8a1babde98be184bb918958ef3))
* **chain:** schedule handlers to the next tick ([#1798](https://github.com/digitty-forks/node-restify/issues/1798)) ([806ed71](https://github.com/digitty-forks/node-restify/commit/806ed7119db9ed4cce77aef3d898aae561224dd8))
* **chain:** use nextTick instead of setImmediate ([#1808](https://github.com/digitty-forks/node-restify/issues/1808)) ([703470a](https://github.com/digitty-forks/node-restify/commit/703470ad82fd01e7f3b2197ebb7eb1b5b37975f8))
* cpuUsageThrottle ([#1460](https://github.com/digitty-forks/node-restify/issues/1460)) ([84be679](https://github.com/digitty-forks/node-restify/commit/84be6799c4a80ae67f3aa03165c8031a55bddc97))
* create inflightRequestThrottle plugin ([#1431](https://github.com/digitty-forks/node-restify/issues/1431)) ([285faf4](https://github.com/digitty-forks/node-restify/commit/285faf4b6a2e56f0e4d9fc6dfaa3dd5e311530c1))
* deprecate req.closed ([d052b7c](https://github.com/digitty-forks/node-restify/commit/d052b7cec561133c002211a20dccf7cc2a8a0897))
* **deps:** replace cover/istanbul with nyc ([#1823](https://github.com/digitty-forks/node-restify/issues/1823)) ([361f83e](https://github.com/digitty-forks/node-restify/commit/361f83e5acd814881c82add3e1bd06ce9ded777c))
* don't override req.log if set during .first ([852d2c1](https://github.com/digitty-forks/node-restify/commit/852d2c153d1815274db8cdd7799625e9740090b3))
* **first:** Handlers that execute ASAP in the req/res lifecycle ([#1756](https://github.com/digitty-forks/node-restify/issues/1756)) ([8178098](https://github.com/digitty-forks/node-restify/commit/8178098d3e85ad9bd13c536b504adf940ef08563))
* **helpers:** add compose feature ([#1660](https://github.com/digitty-forks/node-restify/issues/1660)) ([eb60ef4](https://github.com/digitty-forks/node-restify/commit/eb60ef403ad77b1dd187e199d72e7c80caca248c))
* **http2:** add native HTTP/2 support ([#1489](https://github.com/digitty-forks/node-restify/issues/1489)) ([6b20285](https://github.com/digitty-forks/node-restify/commit/6b202853d62394f0448486c9b5bbc18589fd44e2))
* jsonBodyParser handles extended content types *+json ([#1663](https://github.com/digitty-forks/node-restify/issues/1663)) ([4537514](https://github.com/digitty-forks/node-restify/commit/45375144feb6a215ebfdb967ff0944e3aa21f48d))
* Node.js 26 support ([#1999](https://github.com/digitty-forks/node-restify/issues/1999)) ([fe3ce84](https://github.com/digitty-forks/node-restify/commit/fe3ce84f77fffe403205657c0a30b76bb321f0e7))
* **plugin:** plugin to serve static files ([#1753](https://github.com/digitty-forks/node-restify/issues/1753)) ([a67b25f](https://github.com/digitty-forks/node-restify/commit/a67b25f472c7ec99e63f358b3c1e8801d6261148))
* **plugins:** context, req.get() returns the whole context ([#1739](https://github.com/digitty-forks/node-restify/issues/1739)) ([6e35e01](https://github.com/digitty-forks/node-restify/commit/6e35e01eb6d64f80c0e3db2daf4dbf3f66c35e86))
* **plugins:** do not include user-input in UnsupportedMediaTypeError message (VError fails), move it to info ([#1733](https://github.com/digitty-forks/node-restify/issues/1733)) ([06c220d](https://github.com/digitty-forks/node-restify/commit/06c220d2d9629e3510aed493a8877629bbc0c4ae))
* provide callback to uncaughtException handler ([#1766](https://github.com/digitty-forks/node-restify/issues/1766)) ([5e8b5e2](https://github.com/digitty-forks/node-restify/commit/5e8b5e2b28e32c79c413d9dec2466fe8f1135332))
* remove deprecated spdy protocol ([#1998](https://github.com/digitty-forks/node-restify/issues/1998)) ([7077bbc](https://github.com/digitty-forks/node-restify/commit/7077bbc1b9e285cc03e65f8e5e49d1132ef635e1))
* remove re-routing from handler ([#1847](https://github.com/digitty-forks/node-restify/issues/1847)) ([9153587](https://github.com/digitty-forks/node-restify/commit/9153587c023a876237c1d8bc7491fee4984d9074))
* replace deprecated node apis ([#1997](https://github.com/digitty-forks/node-restify/issues/1997)) ([d610d83](https://github.com/digitty-forks/node-restify/commit/d610d83a62b8d43b9f93e077af1eff23bc493591))
* replace deprecated url.resolve() and url.parse() with WHATWG URL ([#1996](https://github.com/digitty-forks/node-restify/issues/1996)) ([f602304](https://github.com/digitty-forks/node-restify/commit/f602304c89db17633bd056fb02404163fa86ab4e))
* replace module.parent with explicit module param in test helper ([#2001](https://github.com/digitty-forks/node-restify/issues/2001)) ([ba712be](https://github.com/digitty-forks/node-restify/commit/ba712be5d94a629228515d2740e0fb9c670d2e13))
* **req:** add restifyDone event ([#1740](https://github.com/digitty-forks/node-restify/issues/1740)) ([4900d6b](https://github.com/digitty-forks/node-restify/commit/4900d6bdd51fa4e1769678562de69929c38a0c4b))
* revert async formatters ([#1377](https://github.com/digitty-forks/node-restify/issues/1377)) ([a2e300f](https://github.com/digitty-forks/node-restify/commit/a2e300f785edb087da9a52f562bd1f900e9ab47a))
* **router:** add ignoreTrailingSlash router option ([#1632](https://github.com/digitty-forks/node-restify/issues/1632)) ([92ffbf5](https://github.com/digitty-forks/node-restify/commit/92ffbf5cbe49df09d9c59a6081285c12fe5943b4))
* send 500s for unhandled requests ([#1777](https://github.com/digitty-forks/node-restify/issues/1777)) ([885cecd](https://github.com/digitty-forks/node-restify/commit/885cecd7f9753b62faaa930f3cd39329057587f3))
* **server:** new router and middleware system ([#1561](https://github.com/digitty-forks/node-restify/issues/1561)) ([8283277](https://github.com/digitty-forks/node-restify/commit/82832771826321480e5e524db258668f62b689c2))
* support Node.js 20 ([9f1d249](https://github.com/digitty-forks/node-restify/commit/9f1d249c3fd023b05ac15c02352ec937ff7d1299))
* support v18.x ([5795223](https://github.com/digitty-forks/node-restify/commit/57952239fa1808a6cf6e70deb2754c4c85c1be39))
* **throttle plugin:** expose rate limit metrics as headers ([#1453](https://github.com/digitty-forks/node-restify/issues/1453)) ([1627a55](https://github.com/digitty-forks/node-restify/commit/1627a557bd4ed94ba1c6adbe916c51f83bc46059))
* update dependencies ([#2002](https://github.com/digitty-forks/node-restify/issues/2002)) ([120b4bb](https://github.com/digitty-forks/node-restify/commit/120b4bb1fd90f675773a53ae6961eea203baec79))
* upgrade qs ([#1991](https://github.com/digitty-forks/node-restify/issues/1991)) ([aedcb65](https://github.com/digitty-forks/node-restify/commit/aedcb658da9ddbebc3615affa01b93e68deaea46))
* upgrade qs ([#1995](https://github.com/digitty-forks/node-restify/issues/1995)) ([e2d188b](https://github.com/digitty-forks/node-restify/commit/e2d188bfb889e1bacfdd6c886eba49951b784d23))
* use req.log on audit plugin ([528ecbc](https://github.com/digitty-forks/node-restify/commit/528ecbcec5d70c458749bdd4c4cc3f9e06ab69a2))


### Bug Fixes

* 652 - Incorrect error on route with no versions ([#1465](https://github.com/digitty-forks/node-restify/issues/1465)) ([ee15490](https://github.com/digitty-forks/node-restify/commit/ee154908d3ec4fd4a4108019140820c172df66b5))
* Add migration guid to website ([#1402](https://github.com/digitty-forks/node-restify/issues/1402)) ([5f053c7](https://github.com/digitty-forks/node-restify/commit/5f053c7efebc414b5a26daac3cc5e89dc0054fe3))
* add node 7-8 travis support ([#1405](https://github.com/digitty-forks/node-restify/issues/1405)) ([536a473](https://github.com/digitty-forks/node-restify/commit/536a4735266a7f56c205be4c6cafaa6adf81f480))
* add support for secureOptions in createServer ([#1575](https://github.com/digitty-forks/node-restify/issues/1575)) ([656e60e](https://github.com/digitty-forks/node-restify/commit/656e60e03d5fe2b011f8b2198178bc22d749b21f))
* Allow multiple unmerged set-cookie headers. ([#1570](https://github.com/digitty-forks/node-restify/issues/1570)) ([df04015](https://github.com/digitty-forks/node-restify/commit/df04015439becae8e8c48a02cb6e1992d6040037))
* audit timers of same name should accumulate ([#1435](https://github.com/digitty-forks/node-restify/issues/1435)) ([#1443](https://github.com/digitty-forks/node-restify/issues/1443)) ([a2d34aa](https://github.com/digitty-forks/node-restify/commit/a2d34aaa461cabf47147990a1c2910ea9a53b2d8))
* **audit:** use public APIs for accessing response headers ([5169db7](https://github.com/digitty-forks/node-restify/commit/5169db7b1d2c9979e534b2c27912f5be398bcbca))
* **benchmark:** force latest restify version ([#1810](https://github.com/digitty-forks/node-restify/issues/1810)) ([b8ec60e](https://github.com/digitty-forks/node-restify/commit/b8ec60e335b3ce95be4f2507623d357f4a600331))
* **bodyReader:** Fix memory leak ([#1566](https://github.com/digitty-forks/node-restify/issues/1566)) ([756b3f0](https://github.com/digitty-forks/node-restify/commit/756b3f02ba1dec114cf76c4e723ed054170a081c))
* Correct typo in assertion message ([#1904](https://github.com/digitty-forks/node-restify/issues/1904)) ([195cf13](https://github.com/digitty-forks/node-restify/commit/195cf136e3a7de2b2720261dfd459c051b5be037))
* **cpuUsageThrottle:** Always queue a new timeout ([#1484](https://github.com/digitty-forks/node-restify/issues/1484)) ([e4ffe43](https://github.com/digitty-forks/node-restify/commit/e4ffe430b47a2b51fe5fbef00dfa8bd3a1fb66c1))
* **cpuUsageThrottle:** Correctly named handler for debugInfo ([#1499](https://github.com/digitty-forks/node-restify/issues/1499)) ([78b0900](https://github.com/digitty-forks/node-restify/commit/78b0900b0ffcefa86e541c850d27779c5f656f00))
* **cpuUsageThrottle:** dont include interval in lag ([#1504](https://github.com/digitty-forks/node-restify/issues/1504)) ([eecb2d2](https://github.com/digitty-forks/node-restify/commit/eecb2d259deda34c2f297f2ef8b6d4fedc504e9e))
* **cpuUsageThrottle:** support breaking change in pidusage module ([7460064](https://github.com/digitty-forks/node-restify/commit/7460064fc13e5b977a295a2c939e050129c47797))
* create unit tests for sanitizePath plugin ([#1352](https://github.com/digitty-forks/node-restify/issues/1352)) ([12714cf](https://github.com/digitty-forks/node-restify/commit/12714cfce5048c65b4256df660766e863578b90a))
* **dev:** pin to exact versions of linting tools and fix lint errors ([3740a6b](https://github.com/digitty-forks/node-restify/commit/3740a6b7bf6e3bd589d9c1bc0c3d690978270564))
* **dev:** remove nsp since the project merged with npm ([1dc34b4](https://github.com/digitty-forks/node-restify/commit/1dc34b48de361960d7fa37d8bbc82b9d4a612981))
* **dev:** upgrading modules including restify-errors ([#1755](https://github.com/digitty-forks/node-restify/issues/1755)) ([3b71229](https://github.com/digitty-forks/node-restify/commit/3b712298c16577394d16b149be6c9a99044332b2))
* doc site ([#1393](https://github.com/digitty-forks/node-restify/issues/1393)) ([76ee548](https://github.com/digitty-forks/node-restify/commit/76ee5480cfcb7f36e39e3e0955102c04abdac867))
* documentation typo fix ([#1688](https://github.com/digitty-forks/node-restify/issues/1688)) ([0fa7132](https://github.com/digitty-forks/node-restify/commit/0fa71328b8f01f301b0e729f5ef0f00d1b203231))
* documentation update for restifyError event example ([#1398](https://github.com/digitty-forks/node-restify/issues/1398)) ([94fe715](https://github.com/digitty-forks/node-restify/commit/94fe715173ffcebd8814bed7e17a22a24fac4ae8))
* don't create empty clientError listener for http.Server ([#1895](https://github.com/digitty-forks/node-restify/issues/1895)) ([ddc1042](https://github.com/digitty-forks/node-restify/commit/ddc1042af427fe6383ebea37201c06b7b424e72f))
* **dtrace:** route probes ([#1659](https://github.com/digitty-forks/node-restify/issues/1659)) ([84bcded](https://github.com/digitty-forks/node-restify/commit/84bcded77e9a42d3762146802418a1ae1ece8c30))
* emit after event with proper error param for node versions &gt;= 11.4.0 ([#1732](https://github.com/digitty-forks/node-restify/issues/1732)) ([7a1378b](https://github.com/digitty-forks/node-restify/commit/7a1378b0353e9b3f1b630e4cab489c8c578000f5))
* emit restifyError event even for router errors ([#1420](https://github.com/digitty-forks/node-restify/issues/1420)) ([f9d02d5](https://github.com/digitty-forks/node-restify/commit/f9d02d5b358863b9e067da5d6c89b4e283f420ba))
* examples/todoapp/package.json to reduce vulnerabilities ([#1832](https://github.com/digitty-forks/node-restify/issues/1832)) ([d9b27c6](https://github.com/digitty-forks/node-restify/commit/d9b27c602e260fc6c4f0e18e8b6835e89fa2adca))
* exclude package-lock.json ([#1477](https://github.com/digitty-forks/node-restify/issues/1477)) ([011fdf0](https://github.com/digitty-forks/node-restify/commit/011fdf0e2e5b456fe18c9d2ef838819f52586c14))
* fix benchmark tests ([#2000](https://github.com/digitty-forks/node-restify/issues/2000)) ([3009d32](https://github.com/digitty-forks/node-restify/commit/3009d32e665c51cfbf0f6f20cfde6b23a117a08b))
* format falsy constants properly in json formatter ([#1792](https://github.com/digitty-forks/node-restify/issues/1792)) ([3002182](https://github.com/digitty-forks/node-restify/commit/3002182cacc7a9334237a9284a339ba93d3f213c))
* GH-1438, error reponse customization documentation incorrect ([#1439](https://github.com/digitty-forks/node-restify/issues/1439)) ([dd66088](https://github.com/digitty-forks/node-restify/commit/dd66088f3067d4b0858a2dd0274c705faf374e0e))
* Honor port for redirect ([#1363](https://github.com/digitty-forks/node-restify/issues/1363)) ([61c0cb5](https://github.com/digitty-forks/node-restify/commit/61c0cb5c697bcd84c2f7255bfe158619694fb73d))
* **inflightRequestThrottle:** properly handle next ([#1471](https://github.com/digitty-forks/node-restify/issues/1471)) ([4db404f](https://github.com/digitty-forks/node-restify/commit/4db404f979d0da9651c00b076ceefb7b98a4e71f))
* **jsonBodyParser:** fix percent sign causing server fail ([#1411](https://github.com/digitty-forks/node-restify/issues/1411)) ([bde8fda](https://github.com/digitty-forks/node-restify/commit/bde8fda646a6f69b57fd72af1f00d6153fe056ec))
* make arity error message actionable ([#1901](https://github.com/digitty-forks/node-restify/issues/1901)) ([97b6f93](https://github.com/digitty-forks/node-restify/commit/97b6f936e43860873f847bdd752b8090b3119da0))
* monkey patch getHeaders for pre-v7 Node.js (GH-1409) ([82088a7](https://github.com/digitty-forks/node-restify/commit/82088a7185331c7de092450ffec52d815c079739))
* more flaky metrics.test.js fixes ([#1730](https://github.com/digitty-forks/node-restify/issues/1730)) ([71aac42](https://github.com/digitty-forks/node-restify/commit/71aac4283a1ae4ebd3c290afb83487b67010666f))
* npm publish workflow ([#2005](https://github.com/digitty-forks/node-restify/issues/2005)) ([b1000e6](https://github.com/digitty-forks/node-restify/commit/b1000e6822f949428d7936abc4268cbab4fe6023))
* **npm:** exclude extraneous files ([#1818](https://github.com/digitty-forks/node-restify/issues/1818)) ([e8516c3](https://github.com/digitty-forks/node-restify/commit/e8516c3735487ad5ebd332bc781404654c8c3cec))
* **npm:** remove unleash dependency ([#1522](https://github.com/digitty-forks/node-restify/issues/1522)) ([a43aa60](https://github.com/digitty-forks/node-restify/commit/a43aa60f090d29b8e66a58a9656126cb37bf2ef9))
* **package-lock.json:** remove artifacts.netflix.com repo ([#1526](https://github.com/digitty-forks/node-restify/issues/1526)) ([3d2f0f7](https://github.com/digitty-forks/node-restify/commit/3d2f0f7d0ddc14238691944cb9a1a60b02ae5947))
* package.json version now matches npm ([9944dbd](https://github.com/digitty-forks/node-restify/commit/9944dbd57795fa312c8f35c4734977698d70c895))
* **plugins:** save req._matchedVersion ([#1642](https://github.com/digitty-forks/node-restify/issues/1642)) ([69f917a](https://github.com/digitty-forks/node-restify/commit/69f917a3db66fac58f01c9e16535c2e2fcf2172b))
* **plugins:** use process.hrtime() for duration calculation ([#1507](https://github.com/digitty-forks/node-restify/issues/1507)) ([e8efd6c](https://github.com/digitty-forks/node-restify/commit/e8efd6cdcb73e674583e2a7081d2a9b923c72809))
* properly handle non-errors thrown in domains ([#1757](https://github.com/digitty-forks/node-restify/issues/1757)) ([cb2e717](https://github.com/digitty-forks/node-restify/commit/cb2e7177c8b735987aed1c0839747f9658c19bb0))
* proxy events into instance var and add test script ([#1661](https://github.com/digitty-forks/node-restify/issues/1661)) ([de72f49](https://github.com/digitty-forks/node-restify/commit/de72f49eade48cc14dd916916ea86f88d46d3c8a))
* Re-add support for clientError listeners ([#1897](https://github.com/digitty-forks/node-restify/issues/1897)) ([05f12a6](https://github.com/digitty-forks/node-restify/commit/05f12a6864f4fa9aea617a42ae2d5c890478d2df))
* redirect should work even when hostname or protocol is not specified in req.url ([#1497](https://github.com/digitty-forks/node-restify/issues/1497)) ([e696a1f](https://github.com/digitty-forks/node-restify/commit/e696a1f80cd84e7d3db9fb85a18212f970f9a0d3))
* remove invalid triggering of uncaughtException handler ([#1710](https://github.com/digitty-forks/node-restify/issues/1710)) ([ee69806](https://github.com/digitty-forks/node-restify/commit/ee69806a338add1ebfef7eaad92a13273826c98e))
* **request:** date() and time() methods return value ([#1576](https://github.com/digitty-forks/node-restify/issues/1576)) ([4c2cb1a](https://github.com/digitty-forks/node-restify/commit/4c2cb1a7edfe6252e68e409d850aef73961338ca))
* respect when status code is set with res.status (GH-1429) ([#1440](https://github.com/digitty-forks/node-restify/issues/1440)) ([5abc067](https://github.com/digitty-forks/node-restify/commit/5abc06779df3b3ed4faf4d19f0815051a7c3106b))
* Return 444 status code for closed and aborted requests ([#1579](https://github.com/digitty-forks/node-restify/issues/1579)) ([644c198](https://github.com/digitty-forks/node-restify/commit/644c1980aa1a21b0c7fa9aa41e22df9af6eab31e))
* send numbers or bools as payloads ([#1609](https://github.com/digitty-forks/node-restify/issues/1609)) ([0919f26](https://github.com/digitty-forks/node-restify/commit/0919f26db5d5614c0b2fa2567ac2ed43ee70b6d5))
* server should fire not acceptable event ([#1627](https://github.com/digitty-forks/node-restify/issues/1627)) ([8b11b71](https://github.com/digitty-forks/node-restify/commit/8b11b71b487d0001c96312519298f7f85b196471))
* **server:** address domain performance regression with Node v12.x ([#1809](https://github.com/digitty-forks/node-restify/issues/1809)) ([e648d49](https://github.com/digitty-forks/node-restify/commit/e648d491151484f17263c6774678f1e7ac2fa188))
* **server:** address req and res close event changes in Node v10.x ([#1672](https://github.com/digitty-forks/node-restify/issues/1672)) ([6be3fb7](https://github.com/digitty-forks/node-restify/commit/6be3fb7c07483ee1991eba9aaa9ad4897c5a4965))
* **server:** avoid http2 experimental warning without http2 option ([#1555](https://github.com/digitty-forks/node-restify/issues/1555)) ([12da7fd](https://github.com/digitty-forks/node-restify/commit/12da7fdfc68dd9467da97ae0b2f45b89cb540b9b))
* **server:** avoiding uncaughtException in _routeErrorResponse by only sending response when not sent ([#1568](https://github.com/digitty-forks/node-restify/issues/1568)) ([cf65c65](https://github.com/digitty-forks/node-restify/commit/cf65c65cabd06bd5d17d84cd28999248dada94f7))
* **server:** error in pre handler triggers after event ([#1500](https://github.com/digitty-forks/node-restify/issues/1500)) ([c2e6dea](https://github.com/digitty-forks/node-restify/commit/c2e6deae5dab78187a8b09ce5256fb09db390bc9))
* **server:** fix uncaught exceptions triggering route lookups ([#1717](https://github.com/digitty-forks/node-restify/issues/1717)) ([e49cb3b](https://github.com/digitty-forks/node-restify/commit/e49cb3b24c3f4d77fa0b3204f3c1a618fb054789))
* **static:** avoid user-provided data in Error messages being interpreted as sprintf codes ([#1384](https://github.com/digitty-forks/node-restify/issues/1384)) ([#1472](https://github.com/digitty-forks/node-restify/issues/1472)) ([9906344](https://github.com/digitty-forks/node-restify/commit/99063447419e7dcd0bf4ff6c38c5ad1867a2e1f3))
* test static plugin's handling of sprintf escape sequences ([#1391](https://github.com/digitty-forks/node-restify/issues/1391)) ([5d7039a](https://github.com/digitty-forks/node-restify/commit/5d7039a5b97e158347fbb918b866b7aeebd4a14f))
* **test:** make upgrade test pass ([#1772](https://github.com/digitty-forks/node-restify/issues/1772)) ([d30b748](https://github.com/digitty-forks/node-restify/commit/d30b7483c4d035e9a3fa94114557ae9d5f058f79))
* tests broke due to find-my-way update ([f8beaae](https://github.com/digitty-forks/node-restify/commit/f8beaaef64c0541185bc4c2d864948d3c1299cc9))
* update chai (^3.4.1 to ^4.0.0) ([f982d0c](https://github.com/digitty-forks/node-restify/commit/f982d0c71f1b72f79e07f33f6cdf43741242f5d8))
* Update dependency mime to 1.4.0 ([#1467](https://github.com/digitty-forks/node-restify/issues/1467)) ([6d38b38](https://github.com/digitty-forks/node-restify/commit/6d38b38c7a67e9b7cb8500fd1a92751e5ea4ee38))
* update http-signature to v1.0.0 ([#1401](https://github.com/digitty-forks/node-restify/issues/1401)) ([ec88737](https://github.com/digitty-forks/node-restify/commit/ec887376a8314edbb623db48e6288d5a352a4efd))
* use `Buffer.isBuffer` instead of `util.isBuffer`. ([#1593](https://github.com/digitty-forks/node-restify/issues/1593)) ([35bd1c2](https://github.com/digitty-forks/node-restify/commit/35bd1c2b375ea70dc2b4a4549461ff59ff5e4ec4))
* use close event on response instead of socket ([#1892](https://github.com/digitty-forks/node-restify/issues/1892)) ([5c7eb95](https://github.com/digitty-forks/node-restify/commit/5c7eb95319aa54ef3b4b60d000d434824a666e18))
* use more reliable close event ([36318ae](https://github.com/digitty-forks/node-restify/commit/36318ae4c1fee02d3bc3737e34e1ea33e604f674))
* versioned route matching should not throw TypeError ([#1381](https://github.com/digitty-forks/node-restify/issues/1381)) ([25d10f0](https://github.com/digitty-forks/node-restify/commit/25d10f00a4c9128b87cda0261aa3a041ac652f63))


### Miscellaneous Chores

* drop support for node 8 ([bd34988](https://github.com/digitty-forks/node-restify/commit/bd349884321d3e8af549f4d9da4456774e82ac8b))
* remove deprecated usage of pino.child ([#1902](https://github.com/digitty-forks/node-restify/issues/1902)) ([0a8cf83](https://github.com/digitty-forks/node-restify/commit/0a8cf8345de26f8ee98e87c0085f0f9439302d98))
* **travisci:** revisit nodejs version. Change to: LTS active, LTS maintenance (4.x) and stable releases ([#1553](https://github.com/digitty-forks/node-restify/issues/1553)) ([49eb008](https://github.com/digitty-forks/node-restify/commit/49eb008d987f1c425989b78e2336e3583e05a88a))
